...
function DarkModeBlockButton() {
  ...
  return (
    <button
      ...
      className={
        'group duration-200 hover:text-white hover:shadow-md hover:bg-blue-600 flex justify-between items-center px-2 py-2 border dark:border-gray-600  dark:hover:bg-[#df9283]  rounded-lg'
      }>
