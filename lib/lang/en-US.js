export default {
  ...
  COMMON: {
    ...
    COPYRIGHT_NOTICE:
      // 'All articles in this blog, except for special statements, adopt BY-NC-ND 4.0 agreement. Please indicate the source!',
      '如无特别声明，本文版权归©Noooter电子手帐所有， 采用 CC BY-NC-ND 4.0 许可协议，转载请附上原文出处链接和本声明。',
